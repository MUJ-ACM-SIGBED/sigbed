...
export default function Home() {
  return (<>
    <main className="flex min-h-screen flex-col items-center justify-between">
      <section className="bg-cover bg-fixed w-full bg-no-repeat bg-[url('https://live.staticflickr.com/65535/53413681654_14aa5eb9b3_k.jpg')] bg-gray-700 bg-blend-multiply">
