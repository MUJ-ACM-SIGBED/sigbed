...
export default function Home() {
  return (<>
    <main className="flex h-full flex-col items-center justify-between">
      <section className="bg-right bg-fixed w-full bg-no-repeat bg-[url('https://live.staticflickr.com/65535/53413681654_14aa5eb9b3_k.jpg')] bg-gray-700 bg-blend-multiply">
      ...
      <section className="grid bg-transparent py-4 px-3 bg-black grid-cols-2 md:grid-cols-3 gap-3">
        <div className="max-w-sm mx-3 my-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="max-w-sm mx-3 my-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <img className="rounded-t-lg" src="https://live.staticflickr.com/65535/53413681654_14aa5eb9b3_k.jpg" alt="" />

        <div className="p-5">

                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">3D Printed Size Planes</h5>
